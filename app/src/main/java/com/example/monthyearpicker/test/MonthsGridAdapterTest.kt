...
class MonthsGridAdapterTest(val function: (String?) -> Unit) :
    RecyclerView.Adapter<MonthsGridAdapterTest.RecyclerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.layout_month_test, parent, false)
