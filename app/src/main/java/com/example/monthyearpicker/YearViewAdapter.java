...
class YearViewAdapter extends BaseAdapter {
        ...
        public void onMonthClick(MonthView view, int day) {
            ...
            if (isCalendarInRange(day)) {
                ...
                if (mOnDaySelectedListener != null) {
                    mOnDaySelectedListener.onDaySelected(YearViewAdapter.this, day);
                }
            }
        }
    };
    ...
    public interface OnDaySelectedListener {
        void onDaySelected(YearViewAdapter view, int month);
    }
