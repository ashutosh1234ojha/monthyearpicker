...
class MyDialogFragment(val function: (ar: String) -> Unit) : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.layout_dailog, container, false)
        ...
        val adapterYear = YearGridAdapter() { y ->
            year = y
